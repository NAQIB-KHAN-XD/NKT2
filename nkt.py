...
print(logo)
print('\033[1;32m════════════════════════════════════════════════')
NameX =input('\033[1;92m[+] NAQIB-KHAN-XD \033[1;92m: \033[1;92m')
def linex():
	print('\033[1;32m════════════════════════════════════════════════')
def clear():
        os.system('clear')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/Naqib.khan32?mibextid=ZbWKwL');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
